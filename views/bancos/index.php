  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=constant('URL')?>bancos/agregar" method="POST" id="frmBanco">
        <div class="form-row">
        <input type="hidden" class="form-control" name="hId" id="hId" value="0"  >
          ...
          <div class="form-group col-md-6" >
            ...
            <input type="text" class="form-control" name="txtNumero" id="txtNumero" data-validetta="required">
          </div>
          <?php
...
<div class="table-responsive">
                ...
                <td class="text-center">                             
                    <div class="btn-group">
                        ...
                        <a class="btn btn-dark btn-sm" data-toggle="modal" data-target="#exampleModal" onclick="SeleccionarBanco()"><i class="bi bi-pencil"></i></a> 
                    </div>
                </td>
            </tr>
                <?php
...
<script src="<?=constant('URL')?>public/js/bancos.js"></script>
