  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=constant('URL')?>dependencia/agregar" method="POST" id="frmDependencia">
          
        
        <input type="hidden" class="form-control" name="hId" id="hId" value="0"  >
        <div class="form-group">
            <label  class="col-form-label"  >Dependencia:</label>
            <input type="text" class="form-control" name="txtDependencia" id="txtDependencia"   data-validetta="required">
          </div>
...
<div class="col-md-12">
                ...
                <table class="table table-bordered" id="dependencia">
...
<script>
  ...
  <script src="<?=constant('URL')?>public/js/dependencia.js"></script>
