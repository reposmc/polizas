  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Ejercicio Fiscal</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?=constant('URL')?>anio/agregar" method="POST" id="frmAnio">
          
        
        <input type="hidden" class="form-control" name="hId" id="hId" value="0"  >
        <div class="form-group">
            <label  class="col-form-label"  >Año:</label>
            <input type="text" class="form-control" name="txtAnio" id="txtAnio"   data-validetta="required">
            <span id="estado"></span> 
          </div>
...
<div class="col-md-12">
            ...
            <!-- <div class="card">
                ...
                <table class="table table-bordered" id="anio">
                ...
                <td style="display:none;"><?php echo $value['idEjercicio']; ?></td>
...
<script>
  ...
  <script src="<?=constant('URL')?>public/js/anio.js"></script>
