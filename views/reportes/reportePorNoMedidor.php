...
<head>
    ...
    <title>Reporte por No Medidor</title>
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-10 mt-4">
                <div class="card mt-4">
                    ...
                    <div class="card-body">                    
                        <form action="<?=constant('URL')?>reportes/pdfMedidor" method="POST" target="_blank">                
                            <div class="row">
                            <?php
                            ...
                            <div class="col-6">
                                    Dependencia
                                    <select class="form-control" name="sDependencias" id="sDependencias" required>
                                        <option></option>    
                                        <?php
                            ...
                            <div class="col-6">
                                    No Medidor
                                    <select class="form-control" name="sMedidor" id="sMedidor" required>
                                        <option></option>    
                                        <?php
                                            foreach ($this->medidor as $value) {
                                        ?>
                                        <option value="<?=$value['idMedidor']?>"><?=$value['num_Medidor']?></option> 
                                        <?php
                                            }
                                        ?>                                                       
                                    </select>
