...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=constant('URL')?>departamento/agregar"  method="POST" id="frmDepartamentos">
        ...
        <input type="hidden" class="form-control" name="hId" id="hId" value="0"  >
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="txtNombre" placeholder="Nombre del departamento"  id="txtNombre" data-validetta="required">
          </div>
  ...
  <div class="table-responsive">
                <table class="table table-bordered" id="departamento">
            ...
            <td class="text-center">                             
                <div class="btn-group">
                    ...
                    <a href="" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#exampleModal" onclick="SeleccionarDepartamento()"><i class="bi bi-pencil"></i></a> 
                </div>
            </td>
            </tr>
                <?php
...
<script src="<?=constant('URL')?>public/js/departamento.js"></script>
