$(document).ready(function(){
    ...
    $("#btnCancelar").click( function(){
        $(location).attr('href', "../dependencia/index" );
    });
                         ...
                         success : function(response){
                             ...
                             if (response) {
                                 ...
                                 Swal.fire({
                                    ...
                                    window.location = "../dependencia/index";})
    ...
    function SeleccionarDireccion(){
        var contador =0;
        $('#dependencia tbody tr').on('click', function(){
